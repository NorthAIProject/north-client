...
SELECT u.id, u.email, u.password_hash, u.display_name, u.timezone, u.coaching_style, u.created_at, u.updated_at, u.tier, u.onboarded_at, s.expires_at, s.last_seen_at
FROM sessions s
