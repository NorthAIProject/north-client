...
var englishNav = map[string]string{
	...
	"nav.insights.desc":           "How every part of it has been going.",
	"nav.insights.self":           "Summary",
	"nav.activity-insights":       "Activity feed",
	"nav.activity-insights.desc":  "Everything logged, newest first.",
	"nav.activity-insights.nav":   "Activity",
	...
	"nav.nutrition-insights":      "Nutrition insights",
	"nav.nutrition-insights.desc": "Calories and macros against the plan.",
	"nav.nutrition-insights.nav":  "Nutrition",
	"nav.coach-insights":          "Coaching insights",
	"nav.coach-insights.desc":     "How much you and the coach talked.",
	"nav.coach-insights.nav":      "Coaching",
	"nav.spend-insights":          "Model spend",
	"nav.spend-insights.desc":     "What your account spent on model calls.",
	"nav.spend-insights.nav":      "Spend",
