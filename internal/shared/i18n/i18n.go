...
// small files.
var (
	english             = merge(englishNav, englishSettings, englishErrors, englishDashboard, englishCheckins, englishChat, englishGoals, englishCapture, englishDictate, englishLifedomain, englishCare, englishFooter, englishLanding, englishConnections, englishTelegram, englishOAuth, englishNews, englishDay)
	portugueseEuropean  = merge(portugueseEuropeanNav, portugueseEuropeanSettings, portugueseEuropeanErrors, portugueseEuropeanDashboard, portugueseEuropeanCheckins, portugueseEuropeanChat, portugueseEuropeanGoals, portugueseEuropeanCapture, portugueseEuropeanDictate, portugueseEuropeanLifedomain, portugueseEuropeanCare, portugueseEuropeanFooter, portugueseEuropeanLanding, portugueseEuropeanConnections, portugueseEuropeanTelegram, portugueseEuropeanOAuth, portugueseEuropeanNews, portugueseEuropeanDay)
	portugueseBrazilian = merge(portugueseBrazilianNav, portugueseBrazilianSettings, portugueseBrazilianErrors, portugueseBrazilianDashboard, portugueseBrazilianCheckins, portugueseBrazilianChat, portugueseBrazilianGoals, portugueseBrazilianCapture, portugueseBrazilianDictate, portugueseBrazilianLifedomain, portugueseBrazilianCare, portugueseBrazilianFooter, portugueseBrazilianLanding, portugueseBrazilianConnections, portugueseBrazilianTelegram, portugueseBrazilianOAuth, portugueseBrazilianNews, portugueseBrazilianDay)
	spanish             = merge(spanishNav, spanishSettings, spanishErrors, spanishDashboard, spanishCheckins, spanishChat, spanishGoals, spanishCapture, spanishDictate, spanishLifedomain, spanishCare, spanishFooter, spanishLanding, spanishConnections, spanishTelegram, spanishOAuth, spanishNews, spanishDay)
)
