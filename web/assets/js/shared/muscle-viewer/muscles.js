...
export const MUSCLE_ALIASES = {
  ...
  // The two columns you can feel either side of the spine. The spinalis and
  // semispinalis groups lie underneath them, and the colli/capitis segments run up
  // into the neck, where nothing in North's exercise vocabulary is aimed.
  erectors: [
